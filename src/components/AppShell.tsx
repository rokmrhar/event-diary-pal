      ...
      >
        ...
        <div className="flex items-center gap-2 px-3 py-3 border-b border-white/10">
          ...
          <div className="flex items-center gap-1 ml-1">
            ...
            <a href="https://web.emergencyassist.net" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center overflow-hidden">
              <img src="/public/ask.png" alt="ask" className="h-4 w-4 object-contain">
            </a>
        ...
        <div className="flex items-center justify-center py-6 border-b border-white/10">
          <div className="h-16 w-16 rounded-full bg-brand-red flex items-center justify-center shadow-md">
            <Flame className="h-8 w-8 text-brand-red-foreground" />
          </div>
        </div>
